...
local levelFilter = {E=true, W=true, I=true, D=true, A=true}
...
local function settingsLoad()
  ...
  if s then
    ...
    levelFilter = s.levelFilter or {E=true, W=true, I=true, D=true, A=true}
    ...
    tableBgLines[0] = unDefDefault(s.tableBgLines , false)
