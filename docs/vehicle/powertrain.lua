...
local function breakDevice(device)
  ...
  guihooks.message({txt = "vehicle.drivetrain.deviceBroken", context = {deviceName = device.uiName}}, 10, "vehicle.damage.device." .. device.uiName)
...
local function getPartCondition(partTypeData)
  ...
  return powertrainCondition, canProvideCondition
end
