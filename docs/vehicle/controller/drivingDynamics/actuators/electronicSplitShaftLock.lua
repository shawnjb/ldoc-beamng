...
local function init(jbeamData)
  ...
  clutchRatioPID = newPIDParallel(controlParameters.clutchPIDkP, controlParameters.clutchPIDkI, controlParameters.clutchPIDkD, 0, 1)
...
local function setParameters(parameters)
  ...
  if newP or newI or newD then
    clutchRatioPID:setConfig(controlParameters.clutchPIDkP, controlParameters.clutchPIDkI, controlParameters.clutchPIDkD, 0, 1)
  end
end
