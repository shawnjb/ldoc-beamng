...
local function onExtensionLoaded()
  ...
  addEntry(
    {
      level = "/",
      generator = function(entries)
        table.insert(entries, {title = "ui.radialmenu2.ai", priority = 60, ["goto"] = "/ai/", icon = "radial_ai"})
      end
    }
  )
  ...
  addEntry(
    {level = "/funstuff/", title = "ui.radialmenu2.funstuff.Break", icon = "radial_break", onSelect = function()
        beamstate.breakAllBreakgroups()
      end}
  )
  addEntry(
    {level = "/funstuff/", title = "ui.radialmenu2.funstuff.Hinges", icon = "radial_hinges", onSelect = function()
        beamstate.breakHinges()
      end}
  )
  addEntry(
    {level = "/funstuff/", title = "ui.radialmenu2.funstuff.Tires", icon = "garage_wheels", onSelect = function()
        beamstate.deflateTires()
      end}
  )
  addEntry(
    {level = "/funstuff/", title = "ui.radialmenu2.funstuff.Fire", icon = "radial_fire", onSelect = function()
        fire.igniteVehicle()
      end}
  )
  addEntry(
    {level = "/funstuff/", title = "ui.radialmenu2.funstuff.Extinguish", icon = "radial_estinguish", onSelect = function()
        fire.extinguishVehicle()
      end}
  )
  addEntry(
    {level = "/funstuff/", title = "ui.radialmenu2.funstuff.Boom", icon = "radial_boom", onSelect = function()
        fire.explodeVehicle()
      end}
  )
  addEntry(
  ...
  addEntry(
    {
      level = "/manage/",
      title = "ui.radialmenu2.Manage.Home",
      icon = "radial_home",
      priority = 80,
      onSelect = function()
  ...
  addEntry(
    {level = "/manage/", title = "ui.radialmenu2.Manage.Set_home", icon = "radial_set_home", priority = 81, onSelect = function()
        recovery.saveHome()
      end}
  )
