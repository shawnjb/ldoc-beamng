...
local function setIgnitionLevel(params)
  ...
  if not controller.mainController or not controller.mainController.setEngineIgnition then
    return {failReason = "Missing mainController or missing setEngineIgnition function in mainController"}
  end
