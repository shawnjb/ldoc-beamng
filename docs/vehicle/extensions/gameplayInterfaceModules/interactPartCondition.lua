...
local function initConditions(params)
  local dataTypeCheck, dataTypeError = checkTableDataTypes(params, {"table", "number", "number", "number"})
  ...
  partCondition.initConditions(conditions, fallbackOdometer, fallbackIntegrityValue, fallbackVisualValue)
end
...
local function getConditions(params)
  ...
  return partCondition.getConditions()
end
...
local function onExtensionLoaded()
  M.moduleActions.getPartConditions = getConditions
